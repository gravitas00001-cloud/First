...
urlpatterns = [
    ...
    path('password-reset/verify/', views.password_reset_request_page, name='password_reset_verify_page'),
    path('password-reset/new/', views.password_reset_confirm_page, name='password_reset_confirm_page'),
    path('complete-profile/', views.complete_profile_page, name='complete_profile_page'),
    ...
    path('password-reset/resend_otp/', views.resend_password_reset_otp, name='resend_password_reset_otp'),
    path('password-reset/verify_otp/', views.verify_password_reset_otp, name='verify_password_reset_otp'),
